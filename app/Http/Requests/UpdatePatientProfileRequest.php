...
class UpdatePatientProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'emergency_contact1_relationship' => ['required', 'string', 'max:255'],
            'emergency_contact2_name' => ['required', 'string', 'max:255'],
            'emergency_contact2_number' => ['required', 'regex:/^09[0-9]{7,13}$/', "min:11"],
            'emergency_contact2_relationship' => ['required', 'string', 'max:255'],
    ...
    public function messages(): array
    {
        return [
            ...
            'emergency_contact1_number.regex' => 'Please enter a valid contact number',
            'emergency_contact1_number.min' => 'Please enter a valid contact number',
            'emergency_contact2_number.regex' => 'Please enter a valid contact number',
            'emergency_contact2_number.min' => 'Please enter a valid contact number',
