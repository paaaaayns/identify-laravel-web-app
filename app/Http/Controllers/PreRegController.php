...
class PreRegController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'healthcard_number' => ['required', 'string', 'max:50'], // Assuming healthcard_number is alphanumeric
            ...
            'emergency_contact2_name' => ['nullable', 'string', 'max:255'], // Second contact is optional
            'emergency_contact2_number' => ['nullable', 'regex:/^09[0-9]{7,13}$/', "min:11"],
            'emergency_contact2_relationship' => ['nullable', 'string', 'max:100'],

            // Terms
            'terms_and_conditions' => ['required', 'accepted'], // 'accepted' ensures it's checked
            'privacy_policy' => ['required', 'accepted'], // 'accepted' ensures it's checked
        ], [
